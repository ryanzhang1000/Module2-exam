...
function battlebutton() {
    ...
    let word4 = document.getElementsByClassName('marioattack').value;
    let word5 = document.getElementsByClassName('linkattack').value;
    //Message
    let message = '"There are too many ' + word1 + ' to get to the ' + word2 + '!"' + '"Holy ' + word3 + '!"' + ' Mario attacks Link for ' + ' ' + word4 + 'and Link attacks Mario for' + ' ' + word5 + '!"'
